...
import { getUserAreas, getSelectedAreas, saveList, getApplicationRoles, saveApplicationRoles } from '../controllers/areaListController';
import { checkJwt } from '../middlewares/authenticate';
import { checkPermission } from '../middlewares/checkPermission';

const router = Router();

router.get('/areaList/getUserAreas', checkJwt, getUserAreas);
